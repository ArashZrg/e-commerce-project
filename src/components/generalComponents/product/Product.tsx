      ...
      <div className=" w-[90%] h-[80%] flex justify-between items-center mt-[9.5rem] mx-auto">
        ...
        <div className=" w-[55%] h-full flex flex-col px-28 justify-between ">
          ...
          <div className="flex justify-between w-full">
            ...
            <select className="w-[9.6rem] h-[4rem] rounded-[0.8rem] p-[0.8rem] text-[1.6rem] dark:text-dark-text-primary dark:bg-dark-base-text-field dark:border dark:border-dark-base-text-field-stroke">
